...
export const promotionList: PromotionItem[] = [
  {
    ...
    subtitle:
      "โปรฝากครั้งแรก F168 สำหรับสมาชิกใหม่ ฝากเพียง 10 บาท รับโบนัสเพิ่ม 20% สูงสุด 188 บาท เล่นสล็อต ยิงปลา และเกมยอดนิยม ถอนได้จริงหลังเทิร์น 6 เท่า",
    description: `
...
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    subtitle:
      "โปรฝากรายวัน F168 ฝากขั้นต่ำ 100 บาท รับเพิ่ม 10% สูงสุด 2,888 บาท หมวดสล็อตและยิงปลา เทิร์น 8 เท่า ถอนได้จริง",
    description: `
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    subtitle:
      "โปรแนะนำเพื่อน MK8 รับโบนัสสูงสุด 3 ต่อ ทั้งชวนเพื่อน โบนัสสะสม และค่าคอมมิชชั่นรายวันสูงสุด 1.3% ยิ่งชวนยิ่งรวย",
    description: `
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    title: "โบนัสกำไรต่อวัน สล็อต ยิงปลา เกมไพ่ รับสูงสุด 16,888 บาท",
    subtitle:
...
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    title: "โบนัสฝากครั้งแรก MK8 สมาชิกใหม่ รับเพิ่ม 20% สูงสุด 188 บาท",
    subtitle:
      "สมาชิกใหม่ MK8 ฝากครั้งแรก 10 บาท รับโบนัส 20% สูงสุด 188 บาท เล่นสล็อตและยิงปลา เทิร์นโอเวอร์ 6 เท่า ถอนได้จริง",
    description: `
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    title: "หมุนวงล้อเสี่ยงโชค MK8 ลุ้นทองคำและ iPhone 17 Pro Max",
    subtitle:
      "หมุนวงล้อเสี่ยงโชค MK8 เพียงฝากครบ 100 บาทขึ้นไป รับสิทธิ์หมุนวงล้อตามยอดฝาก ลุ้นทองคำ 1 บาท, iPhone 17 Pro Max และโบนัสเงินสดทุกวัน",
    description: `
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    title: "โปรสุ่มแจก MK8 ลุ้นโบนัสฟรีสูงสุด 100 ล้านบาท",
    subtitle:
...
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    title: "สมัครสมาชิกใหม่ MK8 รับเครดิตฟรี 28.8 บาท ไม่ต้องฝาก",
    subtitle:
      "สมาชิกใหม่ MK8 รับเครดิตฟรี 28.8 บาท ไม่ต้องฝากก่อน แค่ยืนยันเบอร์โทรและบัญชี เทิร์นโอเวอร์เพียง 8 เท่า ถอนได้จริงสูงสุด 388 บาท",
    description: `
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    title: "โบนัสฝาก USDT-TRC20 รับเพิ่ม 2% ทุกยอดฝาก ไม่จำกัดครั้ง",
    subtitle:
