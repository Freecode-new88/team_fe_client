...
export const promotionList: PromotionItem[] = [
  {
    ...
    subtitle:
      "ฝากครั้งแรก F168 สมาชิกใหม่ ฝาก 10 บาท รับเพิ่ม 20% สูงสุด 188 บาท เล่นสล็อต ยิงปลา ถอนได้หลังเทิร์น 6 เท่า",
    description: `
...
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    subtitle:
      "หมุนวงล้อเสี่ยงโชค MK8 ฝากครบ 100 บาท รับสิทธิ์หมุน ลุ้นทองคำ 1 บาท, iPhone 17 Pro Max และเงินสดทุกวัน",
    description: `
<section class="space-y-10 text-gray-200 leading-relaxed">
...
<section class="space-y-10 text-gray-200 leading-relaxed">
  ...
  },
  {
    ...
    subtitle:
      "สมาชิกใหม่ MK8 รับเครดิตฟรี 28.8 บาท ไม่ต้องฝาก แค่ยืนยันเบอร์ เทิร์น 8 เท่า ถอนได้สูงสุด 388 บาท",
    description: `
<section class="space-y-10 text-gray-200 leading-relaxed">
